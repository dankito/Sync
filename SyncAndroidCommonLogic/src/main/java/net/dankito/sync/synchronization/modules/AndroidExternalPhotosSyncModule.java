...
public class AndroidExternalPhotosSyncModule extends AndroidPhotosSyncModuleBase {
  ...
  public AndroidExternalPhotosSyncModule(Context context, Localization localization, IThreadPool threadPool, FileSyncService fileSyncService, IFileStorageService fileStorageService) {
